        ...
        <footer>
            <div className="links">
                <div className="box">
                    ...
                    <ul>
                    <li className="cplocation">60, 29th Avenida #343, Lisboa Amadora.</li>
                    <li className="cpphone">+01 2222 365 / +91 1256 789</li>
                    <li><Link to="mailto:#" className="cpemail">kiossocamuegi@gmail.com</Link></li>
            ...
            <div className="copyright">
                <div><p>Copyright © 2024 Hightech store. All Rights Reserved. </p></div>
            </div>
      </footer>
    </div>
  )
